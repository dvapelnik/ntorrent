/**
 * Collaborator: Dmitry Vapelnik <dvapelnik@gmail.com>
 * Simply forked from https://github.com/feross/parse-torrent-file
 * Added some features and supported fields:
 *    - comment
 *    - created by
 *    - publisher
 *    - publisher url
...
function decodeTorrentFile(torrent) {
  ...
  if (torrent.encoding) result.encoding = torrent.encoding.toString();
